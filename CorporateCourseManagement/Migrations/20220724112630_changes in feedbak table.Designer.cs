...
namespace CorporateCourseManagement.Migrations
{
    ...
    [Migration("20220724112630_changes in feedbak table")]
    partial class changesinfeedbaktable
    {
            ...
            modelBuilder.Entity("CorporateCourseManagement.Models.Course", b =>
                {
                    ...
                    b.Property<string>("NameOfTheStudentsEnrolled")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.Property<int>("NoOfStudentsEnrolled")
                        .HasColumnType("int");
